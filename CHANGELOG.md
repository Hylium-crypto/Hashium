...
All notable changes to the Hashium project will be documented in this file.
...
- Hashium-specific genesis blocks for all networks (main/testnet/test4/regtest)
...
### Changed
- Rebranded from Bitcoin to Hashium throughout codebase
- Updated chain parameters for Hashium network
...
Hashium follows **Semantic Versioning** (MAJOR.MINOR.PATCH):
...
Security vulnerabilities should be reported privately to: security@hashium.org
...
Hashium is a fork of Bitcoin Core, honoring the original vision of decentralized, sound money while establishing its own distinct network and community.

[Unreleased]: https://github.com/Panagiotis012/Hashium/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/Panagiotis012/Hashium/releases/tag/v0.1.0
