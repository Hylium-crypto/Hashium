# Hashium Development Roadmap

This document outlines the development phases and milestones for Hashium.
...
|-----------|--------|-------------|
| Fork Bitcoin Core | ✅ Complete | Base codebase from Bitcoin Core |
| Custom Chain Parameters | ✅ Complete | Unique genesis, ports, addresses |
...
**Goal**: Prepare for public testnet and eventual mainnet launch
