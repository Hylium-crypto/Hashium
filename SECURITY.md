...
> **Note**: Hashium is currently in testnet/development phase. Full security support and SLA will be established once mainnet launches.
...
|------|-------------|------|
| Hashium Security Team | `[TO BE ADDED BEFORE MAINNET]` | Primary contact |
...
1. **Day 0**: Vulnerability reported to security@hashium.org
...
### Mandatory
- [ ] Keep Hashium Core updated to latest version
...
- **Security Issues**: security@hashium.org
