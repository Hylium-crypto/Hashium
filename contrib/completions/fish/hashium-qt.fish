...
complete --command hashium-qt --no-files

# Extract options
function __fish_hashiumqt_get_options
...
complete \
    --command hashium-qt \
    --arguments "(__fish_hashiumqt_get_options --nofiles)"
