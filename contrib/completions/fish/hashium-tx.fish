...
# Extract options
function __fish_hashium_tx_get_options
...
# Extract commands
function __fish_hashium_tx_get_commands
...
complete \
    --command hashium-tx \
    --condition "not __fish_hashium_seen_cmd (__fish_hashium_tx_get_commands --commandsonly)" \
    --arguments "(__fish_hashium_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command hashium-tx \
    --arguments "(__fish_hashium_tx_get_commands)" \
    --no-files
