...
complete --command hashiumd --no-files

# Extract options
function __fish_hashiumd_get_options
...
complete \
    --command hashiumd \
    --arguments "(__fish_hashiumd_get_options --nofiles)"
