...
declare -A LIBS
LIBS[cli]="libhashium_cli.a"
LIBS[common]="libhashium_common.a"
LIBS[consensus]="libhashium_consensus.a"
LIBS[crypto]="libhashium_crypto.a"
LIBS[node]="libhashium_node.a"
LIBS[util]="libhashium_util.a"
LIBS[wallet]="libhashium_wallet.a"
...
# https://github.com/hashium/hashium/issues/10102
