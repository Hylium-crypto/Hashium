...
(define* (make-hashium-cross-toolchain target
                                       #:key
...
desirable for building Hashium Core release binaries."
...
;; failure; see https://github.com/hashium/hashium/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-hashium-cross-toolchain target)))
