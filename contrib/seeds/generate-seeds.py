...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef HSMIUM_CHAINPARAMSSEEDS_H\n')
    g.write('#define HSMIUM_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the hashium network\n')
    ...
    g.write('#endif // HSMIUM_CHAINPARAMSSEEDS_H\n')
