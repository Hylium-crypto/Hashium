...
"""Example logging Hashium Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/hashiumd
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[hashiumd_with_usdts])
