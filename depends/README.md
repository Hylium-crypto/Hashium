...
Hashium Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Hashium Core

**When configuring Hashium Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Hashium Core:
...
variables will be set when generating the Hashium Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
