# Hashium Production Release Guide

## ✅ Pre-Release Checklist

### Code Quality
- [x] All Hashium tests passing
...
- [ ] PGP keys generated
- [ ] security@hashium.org configured
...
2. Name: `hashium` or `hashium-core`
3. Create new repository: `hashium`
...
# Commit
git commit -m "Hashium v0.1.0 - Initial Release"

# Add remote (change to your repo URL)
git remote add origin https://github.com/YOUR_ORG/hashium.git
...
2. Tag: `v0.1.0`
3. Title: `Hashium v0.1.0 - Testnet Release`
4. Description:
```markdown
## Hashium v0.1.0 - Testnet Release
...
### Security
Report vulnerabilities to security@hashium.org
...
# 2. Build Hashium using the generated toolchain
cmake -B build -G Ninja \
...
# RSA 4096, no expiry, your-email@hashium.org
```

### Sign Release
```bash
gpg --armor --detach-sign hashium-0.1.0-x86_64-linux.tar.gz
```
