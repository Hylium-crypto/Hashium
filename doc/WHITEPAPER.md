# Hashium: A Bitcoin-Derived Cryptocurrency for the Next Generation
...
Hashium is a new cryptocurrency built on the proven foundation of Bitcoin Core. By inheriting Bitcoin's battle-tested consensus mechanism and cryptographic primitives while launching with modern features enabled from genesis, Hashium aims to provide a secure, decentralized digital currency that learns from Bitcoin's 15+ years of operation.

This whitepaper describes Hashium's technical design, economic model, and distinguishing characteristics.
...
Hashium is created with three core objectives:
...
> *"Verify, don't trust."* — Hashium Genesis Message
...
Hashium is derived from Bitcoin Core, the reference implementation of Bitcoin. This provides:
...
| Component | Bitcoin | Hashium |
|-----------|---------|--------|
| Network ID | Bitcoin mainnet | Hashium mainnet (unique) |
| P2P Port | 8333 | 9333 |
| RPC Port | 8332 | 9332 |
...
Message:      "Hashium 2025-12-16: Verify, don't trust."
nBits:        0x1d00ffff (Difficulty 1)
Output:       OP_RETURN (No premine)
```

The genesis coinbase uses OP_RETURN, making the initial 50 HSM **provably unspendable**. This demonstrates commitment to fair distribution.
...
Hashium uses the same SHA-256d proof-of-work algorithm as Bitcoin:
...
| Initial Block Reward | 50 HSM |
| Halving Interval | 210,000 blocks (~4 years) |
| Smallest Unit | 1 satoshi = 0.00000001 HSM |

### 5.2 Emission Curve

| Era | Block Range | Reward | Cumulative Supply |
|-----|-------------|--------|-------------------|
| 0 | 0-209,999 | 50 HSM | 10,500,000 HSM |
| 1 | 210,000-419,999 | 25 HSM | 15,750,000 HSM |
| 2 | 420,000-629,999 | 12.5 HSM | 18,375,000 HSM |
| 3 | 630,000-839,999 | 6.25 HSM | 19,687,500 HSM |
| ... | ... | ... | ... |
| 64+ | 13,230,000+ | 0 HSM | 21,000,000 HSM |
...
Hashium inherits Bitcoin's threat model, defending against:
...
Hashium represents a fresh start built on proven fundamentals. By combining Bitcoin's battle-tested codebase with a clean launch that includes all modern improvements from genesis, Hashium offers a secure, transparent, and decentralized cryptocurrency for the next generation.
...
**Disclaimer**: This whitepaper is for informational purposes only. Hashium is experimental software. Use at your own risk.

**License**: This document is released under CC-BY-4.0.

---

*Hashium Development Team*  
*December 2025*
