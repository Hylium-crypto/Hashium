...
Assumeutxo is a feature that allows fast bootstrapping of a validating hashiumd
instance.
...
```
$ hashium-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ hashium-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
