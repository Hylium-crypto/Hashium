UNIX BUILD NOTES
====================
Some notes on how to build Hashium Core in Unix.
...
memory available when compiling Hashium Core. On systems with less, gcc can be
...
To build Hashium Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Hashium Core can
