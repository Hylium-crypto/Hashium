# Hashium Consensus Rules Specification

**Version:** 1.0.0
**Last Updated:** 2025-12-24
**Status:** Normative Specification

This document defines the complete consensus rules for the Hashium cryptocurrency. Any implementation claiming Hashium compatibility MUST follow these rules exactly. Deviation from these rules will result in chain splits and network incompatibility.
...
2. **Input/Output Validity:**
   ...
   - At least one output
   - No output value > 21,000,000 HSM
...
Hashium uses **double SHA-256** (SHA256d) for proof-of-work:
...
|--------|---------|-----|
| 0 - 209,999 | 50 HSM | 0 |
| 210,000 - 419,999 | 25 HSM | 1 |
| 420,000 - 629,999 | 12.5 HSM | 2 |
| 630,000 - 839,999 | 6.25 HSM | 3 |
| ... | ... | ... |
| 13,230,000+ | 0 HSM | 64+ |
...
Hashium inherits Bitcoin's script system with the following active features:
...
Message: "Hashium testnet 2025-12-16: break safely."
```
...
See `contrib/devtools/genesis_hashium.cpp` for reference implementation.
...
**CRITICAL:** This specification is the authoritative definition of Hashium consensus. Any ambiguity or conflict with code MUST be resolved in favor of this document for future implementations. The reference implementation (Hashium Core) is considered canonical for unspecified edge cases until this document is updated.
