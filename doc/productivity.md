...
```sh
cmake --build build --target hashiumd hashium-cli
cmake --build build --target hashium-qt
cmake --build build --target bench_hashium
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:hashium/hashium.git
```
...
> e.g. github.com/hashium/hashium.git or for the GUI github.com/hashium-core/gui
