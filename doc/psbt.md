# PSBT Howto for Hashium Core

Since Hashium Core 0.17, an RPC interface exists for Partially Signed Hashium
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/hashium/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Hashium transactions that are not fully signed
...
#### Multisig with multiple Hashium Core instances
