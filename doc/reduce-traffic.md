...
By default, Hashium Core allows up to 125 connections to different peers, 11 of
...
limits are tiny. Keep in mind that hashium's trustless model works best if you are
