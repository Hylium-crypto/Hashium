Hashium Core version 0.10.3 is now available from:

  <https://hashium.org/bin/hashium-core-0.10.3/>
...
(see https://github.com/hashium/hashium/pull/6793, as well as the 0.11.0
