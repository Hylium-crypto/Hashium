Hashium Core version 0.10.4 is now available from:

  <https://hashium.org/bin/hashium-core-0.10.4/>
...
- #6953 `43c2789` Split hashium-tx into its own package
- #6953 `dfe0d4d` Include hashium-tx binary on Debian/Ubuntu
