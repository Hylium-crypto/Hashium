Hashium Core version 0.13.2 is now available from:

  <https://hashium.org/bin/hashium-core-0.13.2/>
...
- #8908 `4a974b2` Update hashium-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow hashium-tx to create v2 transactions (hyldrak)
