Hashium Core version *0.15.2* is now available from:

  <https://hashiumcore.org/bin/hashium-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in hashium-tx (TheBlueMatt)
