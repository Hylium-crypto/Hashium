Hashium Core version 0.16.1 is now available from:

  <https://hashiumcore.org/bin/hashium-core-0.16.1/>
...
- #12843 `df38b13` Test starting hashiumd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure hashiumd processes are cleaned up when tests end (sdaftuar)
