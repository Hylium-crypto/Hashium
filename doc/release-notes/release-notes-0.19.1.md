...
Hashium Core version 0.19.1 is now available from:

  <https://hashiumcore.org/bin/hashium-core-0.19.1/>
...
From Hashium Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Hashium Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Hashium Core does not yet change appearance when
...
- #17488 fix "hashiumd already running" warnings on macOS (fanquake)
