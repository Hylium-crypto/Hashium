Download URL: https://sourceforge.net/projects/hashium/files/Hashium/hashium-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 HSM fee schedule (users still pay 0.01 HSM per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #hashium00 - #hashium99
