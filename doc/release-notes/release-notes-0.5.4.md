Hashium version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hashium/files/Hashium/hashium-0.5.4/
...
http://gitorious.org/hashium/hashiumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Hashium-Qt notifications under Growl 1.3.
Increase required age of Hashium-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHashium properly when installing Hashium-Qt over it. (Windows)
