Hashium-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/hashium/files/Hashium/hashium-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Hashium
...
New/changed settings (command-line or hashium.conf file)
--------------------------------------------------------
