Hashium Core version 0.9.2.1 is now available from:

  https://hashium.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 HSM to 0.01 HSM
...
- Fix "Start hashium on system login"
