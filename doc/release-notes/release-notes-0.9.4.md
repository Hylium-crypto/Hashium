Hashium Core version 0.9.4 is now available from:

  https://hashium.org/bin/0.9.4/
...
this update is incompatible with the Hashium system and could lead to consensus
forks.

Hashium Core released binaries from https://hashium.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~hashium/+archive/ubuntu/hashium
- A third-party or self-compiled Hashium Core

upgrade to Hashium Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
