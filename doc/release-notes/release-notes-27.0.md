Hashium Core version 27.0 is now available from:

  <https://hashiumcore.org/bin/hashium-core-27.0/>
...
- libhashiumconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libhashiumkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Hashium Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Hashium Core would
