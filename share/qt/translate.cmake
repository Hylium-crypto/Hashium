...
function(extract_strings output)
  ...
  file(STRINGS "hashiumstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *hashium_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"hashium-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/hashiumstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/hashiumstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/hashium_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/hashium_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/hashium_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/hashium_en.xlf" hashium_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" hashium_en "${hashium_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" hashium_en "${hashium_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/hashium_en.xlf" "${hashium_en}")
