...
#ifndef HSMIUM_COMMON_ARGS_H
#define HSMIUM_COMMON_ARGS_H
...
extern const char * const HSMIUM_CONF_FILENAME;
extern const char * const HSMIUM_SETTINGS_FILENAME;
