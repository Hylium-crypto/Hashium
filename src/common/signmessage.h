...
#ifndef HSMIUM_COMMON_SIGNMESSAGE_H
#define HSMIUM_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's hashium address, it must refer to a public key.
...
#endif // HSMIUM_COMMON_SIGNMESSAGE_H
