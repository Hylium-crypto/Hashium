...
#ifndef HSMIUM_INTERFACES_INIT_H
#define HSMIUM_INTERFACES_INIT_H
...
//! (hashium-gui, hashium-node, hashium-wallet, hashiumd, hashium-qt) and each
...
#endif // HSMIUM_INTERFACES_INIT_H
