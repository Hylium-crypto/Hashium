...
#ifndef HSMIUM_INTERFACES_NODE_H
#define HSMIUM_INTERFACES_NODE_H
...
//! Top-level interface for a hashium node (hashiumd process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or hashium.conf.
...
#endif // HSMIUM_INTERFACES_NODE_H
