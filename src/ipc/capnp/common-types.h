...
#ifndef HSMIUM_IPC_CAPNP_COMMON_TYPES_H
#define HSMIUM_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between hashium processes.
...
//! Functions to serialize / deserialize common hashium types.
namespace mp {
...
#endif // HSMIUM_IPC_CAPNP_COMMON_TYPES_H
