...
extern thread_local ThreadContext g_thread_context; // NOLINT(hashium-nontrivial-threadlocal)
// Silence nonstandard hashium tidy error "Variable with non-trivial destructor
