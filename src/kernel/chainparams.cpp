                                             ...
                                             uint32_t extra_nonce)
{
    ...
    // ScriptSig layout matches genesis_hashium tool: prefix + raw message bytes.
...
static CScript HashiumGenesisOutputScript()
{
    static const std::string kGenesisOutput = "Hashium genesis";
...
public:
    CMainParams()
    {
        ...
        // Using regtest-style powLimit since our genesis uses 0x207fffff difficulty
         ...
         */
        // Distinct Hashium mainnet message start to avoid cross-talk with Bitcoin.
        ...
        // Hashium Mainnet Genesis Block - December 27, 2025
        const char* pszTimestamp = "Hashium 27/Dec/2025 Security Scarcity Store of Value";
        const CScript genesisOutputScript = HashiumGenesisOutputScript();
        // nTime: 1735307400 = Dec 27, 2025 14:30 UTC
        genesis = CreateGenesisBlockRawScriptSig(pszTimestamp, genesisOutputScript, 1735307400, 10, 0x207fffff, 1, 50 * COIN, false, 0);
...
public:
    CTestNetParams()
    {
        ...
        const char* pszTimestamp = "Hashium testnet 2025-12-16: break safely.";
        const CScript genesisOutputScript = HashiumGenesisOutputScript();
        ...
        vSeeds = {"testnet-seed1.hashium.org.", "testnet-seed2.hashium.org."};
...
public:
    CTestNet4Params()
    {
        ...
        const char* testnet4_genesis_msg = "Hashium test4 2025-12-16: staging chain.";
        const CScript testnet4_genesis_script = HashiumGenesisOutputScript();
        ...
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds = {"testnet4-seed1.hashium.org.", "testnet4-seed2.hashium.org."};
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vFixedSeeds.clear();
            vSeeds = {"seed.signet.hashium.org."};
