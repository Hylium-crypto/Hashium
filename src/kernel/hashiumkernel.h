// Copyright (c) 2024-present The Hashium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HSMIUM_KERNEL_HSMIUMKERNEL_H
#define HSMIUM_KERNEL_HSMIUMKERNEL_H
...
#ifndef HSMIUMKERNEL_API
    #ifdef HSMIUMKERNEL_BUILD
        #if defined(_WIN32)
            #define HSMIUMKERNEL_API __declspec(dllexport)
        #else
            #define HSMIUMKERNEL_API __attribute__((visibility("default")))
        #endif
    #else
        #if defined(_WIN32) && !defined(HSMIUMKERNEL_STATIC)
            #define HSMIUMKERNEL_API __declspec(dllimport)
        #else
            #define HSMIUMKERNEL_API
        #endif
    #endif
#endif
...
/* Warning attributes */
#if defined(__GNUC__)
    #define HSMIUMKERNEL_WARN_UNUSED_RESULT __attribute__((__warn_unused_result__))
#else
    #define HSMIUMKERNEL_WARN_UNUSED_RESULT
#endif

/**
 * HSMIUMKERNEL_ARG_NONNULL is a compiler attribute used to indicate that
 ...
 */
#if !defined(HSMIUMKERNEL_BUILD) && defined(__GNUC__)
    #define HSMIUMKERNEL_ARG_NONNULL(...) __attribute__((__nonnull__(__VA_ARGS__)))
#else
    #define HSMIUMKERNEL_ARG_NONNULL(...)
#endif
 ...
 *
 * This header currently exposes an API for interacting with parts of Hashium
 ...
 * also not yet included in releases of Hashium Core.
 *
...
/**
 * Function signature for the global logging callback. All hashium kernel
 ...
 */
HSMIUMKERNEL_API hylk_Transaction* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_create(
 ...
 */
HSMIUMKERNEL_API hylk_Transaction* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_copy(
    const hylk_Transaction* transaction) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 * @return                0 on success.
 */
HSMIUMKERNEL_API int hylk_transaction_to_bytes(
    const hylk_Transaction* transaction,
    hylk_WriteBytes writer,
    void* user_data) HSMIUMKERNEL_ARG_NONNULL(1, 2);
 ...
 */
HSMIUMKERNEL_API size_t HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_count_outputs(
    const hylk_Transaction* transaction) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API const hylk_TransactionOutput* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_get_output_at(
    const hylk_Transaction* transaction, size_t output_index) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API const hylk_TransactionInput* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_get_input_at(
    const hylk_Transaction* transaction, size_t input_index) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API size_t HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_count_inputs(
    const hylk_Transaction* transaction) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 * @return                The txid.
 */
HSMIUMKERNEL_API const hylk_Txid* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_get_txid(
    const hylk_Transaction* transaction) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction.
 */
HSMIUMKERNEL_API void hylk_transaction_destroy(hylk_Transaction* transaction);
 ...
 */
HSMIUMKERNEL_API hylk_ScriptPubkey* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_script_pubkey_create(
 ...
 */
HSMIUMKERNEL_API hylk_ScriptPubkey* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_script_pubkey_copy(
    const hylk_ScriptPubkey* script_pubkey) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_script_pubkey_verify(
    ...
    hylk_ScriptVerifyStatus* status) HSMIUMKERNEL_ARG_NONNULL(1, 3);
 ...
 * @return                  0 on success.
 */
HSMIUMKERNEL_API int hylk_script_pubkey_to_bytes(
    const hylk_ScriptPubkey* script_pubkey,
    hylk_WriteBytes writer,
    void* user_data) HSMIUMKERNEL_ARG_NONNULL(1, 2);
 ...
 */
HSMIUMKERNEL_API void hylk_script_pubkey_destroy(hylk_ScriptPubkey* script_pubkey);
 ...
 * @return                  The transaction output.
 */
HSMIUMKERNEL_API hylk_TransactionOutput* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_output_create(
    const hylk_ScriptPubkey* script_pubkey,
    int64_t amount) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 * @return                       The script pubkey.
 */
HSMIUMKERNEL_API const hylk_ScriptPubkey* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_output_get_script_pubkey(
    const hylk_TransactionOutput* transaction_output) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 * @return                       The amount.
 */
HSMIUMKERNEL_API int64_t HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_output_get_amount(
    const hylk_TransactionOutput* transaction_output) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API hylk_TransactionOutput* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_output_copy(
    const hylk_TransactionOutput* transaction_output) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction output.
 */
HSMIUMKERNEL_API void hylk_transaction_output_destroy(hylk_TransactionOutput* transaction_output);
 ...
 * already exists.
 */
HSMIUMKERNEL_API void hylk_logging_disable();
 ...
 */
HSMIUMKERNEL_API void hylk_logging_set_options(const hylk_LoggingOptions options);
 ...
 */
HSMIUMKERNEL_API void hylk_logging_set_level_category(hylk_LogCategory category, hylk_LogLevel level);
 ...
 */
HSMIUMKERNEL_API void hylk_logging_enable_category(hylk_LogCategory category);
 ...
 */
HSMIUMKERNEL_API void hylk_logging_disable_category(hylk_LogCategory category);
 ...
 */
HSMIUMKERNEL_API hylk_LoggingConnection* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_logging_connection_create(
    hylk_LogCallback log_callback,
    void* user_data,
    hylk_DestroyCallback user_data_destroy_callback) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Stop logging and destroy the logging connection.
 */
HSMIUMKERNEL_API void hylk_logging_connection_destroy(hylk_LoggingConnection* logging_connection);
 ...
 */
HSMIUMKERNEL_API hylk_ChainParameters* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chain_parameters_create(
    const hylk_ChainType chain_type);

/**
 * Copy the chain parameters.
 */
HSMIUMKERNEL_API hylk_ChainParameters* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chain_parameters_copy(
    const hylk_ChainParameters* chain_parameters) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the chain parameters.
 */
HSMIUMKERNEL_API void hylk_chain_parameters_destroy(hylk_ChainParameters* chain_parameters);
 ...
 */
HSMIUMKERNEL_API hylk_ContextOptions* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_context_options_create();
 ...
 */
HSMIUMKERNEL_API void hylk_context_options_set_chainparams(
    hylk_ContextOptions* context_options,
    const hylk_ChainParameters* chain_parameters) HSMIUMKERNEL_ARG_NONNULL(1, 2);
 ...
 */
HSMIUMKERNEL_API void hylk_context_options_set_notifications(
    hylk_ContextOptions* context_options,
    hylk_NotificationInterfaceCallbacks notifications) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 *                                           user.
 */
HSMIUMKERNEL_API void hylk_context_options_set_validation_interface(
    hylk_ContextOptions* context_options,
    hylk_ValidationInterfaceCallbacks validation_interface_callbacks) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the context options.
 */
HSMIUMKERNEL_API void hylk_context_options_destroy(hylk_ContextOptions* context_options);
 ...
 */
HSMIUMKERNEL_API hylk_Context* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_context_create(
    const hylk_ContextOptions* context_options);

/**
 * Copy the context.
 */
HSMIUMKERNEL_API hylk_Context* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_context_copy(
    const hylk_Context* context) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_context_interrupt(
    hylk_Context* context) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the context.
 */
HSMIUMKERNEL_API void hylk_context_destroy(hylk_Context* context);
 ...
 */
HSMIUMKERNEL_API const hylk_BlockTreeEntry* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_tree_entry_get_previous(
    const hylk_BlockTreeEntry* block_tree_entry) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int32_t HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_tree_entry_get_height(
    const hylk_BlockTreeEntry* block_tree_entry) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API const hylk_BlockHash* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_tree_entry_get_block_hash(
    const hylk_BlockTreeEntry* block_tree_entry) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_tree_entry_equals(
    const hylk_BlockTreeEntry* entry1, const hylk_BlockTreeEntry* entry2) HSMIUMKERNEL_ARG_NONNULL(1, 2);
 ...
 */
HSMIUMKERNEL_API hylk_ChainstateManagerOptions* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chainstate_manager_options_create(
    const hylk_Context* context,
    const char* data_directory,
    size_t data_directory_len,
    const char* blocks_directory,
    size_t blocks_directory_len) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API void hylk_chainstate_manager_options_set_worker_threads_num(
    hylk_ChainstateManagerOptions* chainstate_manager_options,
    int worker_threads) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chainstate_manager_options_set_wipe_dbs(
    hylk_ChainstateManagerOptions* chainstate_manager_options,
    int wipe_block_tree_db,
    int wipe_chainstate_db) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API void hylk_chainstate_manager_options_update_block_tree_db_in_memory(
    hylk_ChainstateManagerOptions* chainstate_manager_options,
    int block_tree_db_in_memory) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API void hylk_chainstate_manager_options_update_chainstate_db_in_memory(
    hylk_ChainstateManagerOptions* chainstate_manager_options,
    int chainstate_db_in_memory) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the chainstate manager options.
 */
HSMIUMKERNEL_API void hylk_chainstate_manager_options_destroy(hylk_ChainstateManagerOptions* chainstate_manager_options);
 ...
 */
HSMIUMKERNEL_API hylk_ChainstateManager* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chainstate_manager_create(
    const hylk_ChainstateManagerOptions* chainstate_manager_options) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chainstate_manager_import_blocks(
    hylk_ChainstateManager* chainstate_manager,
    const char** block_file_paths_data, size_t* block_file_paths_lens,
    size_t block_file_paths_data_len) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chainstate_manager_process_block(
    hylk_ChainstateManager* chainstate_manager,
    const hylk_Block* block,
    int* new_block) HSMIUMKERNEL_ARG_NONNULL(1, 2, 3);
 ...
 * @return                       The chain.
 */
HSMIUMKERNEL_API const hylk_Chain* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chainstate_manager_get_active_chain(
    const hylk_ChainstateManager* chainstate_manager) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API const hylk_BlockTreeEntry* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chainstate_manager_get_block_tree_entry_by_hash(
    const hylk_ChainstateManager* chainstate_manager,
    const hylk_BlockHash* block_hash) HSMIUMKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the chainstate manager.
 */
HSMIUMKERNEL_API void hylk_chainstate_manager_destroy(hylk_ChainstateManager* chainstate_manager);
 ...
 */
HSMIUMKERNEL_API hylk_Block* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_read(
    const hylk_ChainstateManager* chainstate_manager,
    const hylk_BlockTreeEntry* block_tree_entry) HSMIUMKERNEL_ARG_NONNULL(1, 2);
 ...
 */
HSMIUMKERNEL_API hylk_Block* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_create(
 ...
 */
HSMIUMKERNEL_API hylk_Block* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_copy(
    const hylk_Block* block) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API size_t HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_count_transactions(
    const hylk_Block* block) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API const hylk_Transaction* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_get_transaction_at(
    const hylk_Block* block, size_t transaction_index) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 * @return    The block hash.
 */
HSMIUMKERNEL_API hylk_BlockHash* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_get_hash(
    const hylk_Block* block) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 * @return              0 on success.
 */
HSMIUMKERNEL_API int hylk_block_to_bytes(
    const hylk_Block* block,
    hylk_WriteBytes writer,
    void* user_data) HSMIUMKERNEL_ARG_NONNULL(1, 2);
 ...
 * Destroy the block.
 */
HSMIUMKERNEL_API void hylk_block_destroy(hylk_Block* block);
 ...
 */
HSMIUMKERNEL_API hylk_ValidationMode hylk_block_validation_state_get_validation_mode(
    const hylk_BlockValidationState* block_validation_state) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Returns the validation result from an opaque block validation state pointer.
 */
HSMIUMKERNEL_API hylk_BlockValidationResult hylk_block_validation_state_get_block_validation_result(
    const hylk_BlockValidationState* block_validation_state) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int32_t HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chain_get_height(
    const hylk_Chain* chain) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API const hylk_BlockTreeEntry* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chain_get_by_height(
    const hylk_Chain* chain,
    int block_height) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 *
 */
HSMIUMKERNEL_API int HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_chain_contains(
    const hylk_Chain* chain,
    const hylk_BlockTreeEntry* block_tree_entry) HSMIUMKERNEL_ARG_NONNULL(1, 2);
 ...
 */
HSMIUMKERNEL_API hylk_BlockSpentOutputs* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_spent_outputs_read(
    const hylk_ChainstateManager* chainstate_manager,
    const hylk_BlockTreeEntry* block_tree_entry) HSMIUMKERNEL_ARG_NONNULL(1, 2);
 ...
 */
HSMIUMKERNEL_API hylk_BlockSpentOutputs* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_spent_outputs_copy(
    const hylk_BlockSpentOutputs* block_spent_outputs) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API size_t HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_spent_outputs_count(
    const hylk_BlockSpentOutputs* block_spent_outputs) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API const hylk_TransactionSpentOutputs* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_spent_outputs_get_transaction_spent_outputs_at(
    const hylk_BlockSpentOutputs* block_spent_outputs,
    size_t transaction_spent_outputs_index) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the block spent outputs.
 */
HSMIUMKERNEL_API void hylk_block_spent_outputs_destroy(hylk_BlockSpentOutputs* block_spent_outputs);
 ...
 */
HSMIUMKERNEL_API hylk_TransactionSpentOutputs* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_spent_outputs_copy(
    const hylk_TransactionSpentOutputs* transaction_spent_outputs) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API size_t HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_spent_outputs_count(
    const hylk_TransactionSpentOutputs* transaction_spent_outputs) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API const hylk_Coin* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_spent_outputs_get_coin_at(
    const hylk_TransactionSpentOutputs* transaction_spent_outputs,
    size_t coin_index) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction spent outputs.
 */
HSMIUMKERNEL_API void hylk_transaction_spent_outputs_destroy(hylk_TransactionSpentOutputs* transaction_spent_outputs);
 ...
 */
HSMIUMKERNEL_API hylk_TransactionInput* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_input_copy(
    const hylk_TransactionInput* transaction_input) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API const hylk_TransactionOutPoint* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_input_get_out_point(
    const hylk_TransactionInput* transaction_input) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction input.
 */
HSMIUMKERNEL_API void hylk_transaction_input_destroy(hylk_TransactionInput* transaction_input);
 ...
 */
HSMIUMKERNEL_API hylk_TransactionOutPoint* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_out_point_copy(
    const hylk_TransactionOutPoint* transaction_out_point) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API uint32_t HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_out_point_get_index(
    const hylk_TransactionOutPoint* transaction_out_point) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 * @return                          The txid.
 */
HSMIUMKERNEL_API const hylk_Txid* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_transaction_out_point_get_txid(
    const hylk_TransactionOutPoint* transaction_out_point) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction out point.
 */
HSMIUMKERNEL_API void hylk_transaction_out_point_destroy(hylk_TransactionOutPoint* transaction_out_point);
 ...
 */
HSMIUMKERNEL_API hylk_Txid* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_txid_copy(
    const hylk_Txid* txid) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_txid_equals(
    const hylk_Txid* txid1, const hylk_Txid* txid2) HSMIUMKERNEL_ARG_NONNULL(1, 2);
 ...
 */
HSMIUMKERNEL_API void hylk_txid_to_bytes(
    const hylk_Txid* txid, unsigned char output[32]) HSMIUMKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the txid.
 */
HSMIUMKERNEL_API void hylk_txid_destroy(hylk_Txid* txid);
 ...
 */
HSMIUMKERNEL_API hylk_Coin* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_coin_copy(
    const hylk_Coin* coin) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API uint32_t HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_coin_confirmation_height(
    const hylk_Coin* coin) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_coin_is_coinbase(
    const hylk_Coin* coin) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API const hylk_TransactionOutput* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_coin_get_output(
    const hylk_Coin* coin) HSMIUMKERNEL_ARG_NONNULL(1);

/**
 * Destroy the coin.
 */
HSMIUMKERNEL_API void hylk_coin_destroy(hylk_Coin* coin);
 ...
 */
HSMIUMKERNEL_API hylk_BlockHash* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_hash_create(
    const unsigned char block_hash[32]) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API int HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_hash_equals(
    const hylk_BlockHash* hash1, const hylk_BlockHash* hash2) HSMIUMKERNEL_ARG_NONNULL(1, 2);
 ...
 */
HSMIUMKERNEL_API hylk_BlockHash* HSMIUMKERNEL_WARN_UNUSED_RESULT hylk_block_hash_copy(
    const hylk_BlockHash* block_hash) HSMIUMKERNEL_ARG_NONNULL(1);
 ...
 */
HSMIUMKERNEL_API void hylk_block_hash_to_bytes(
    const hylk_BlockHash* block_hash, unsigned char output[32]) HSMIUMKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the block hash.
 */
HSMIUMKERNEL_API void hylk_block_hash_destroy(hylk_BlockHash* block_hash);
...
#endif // HSMIUM_KERNEL_HSMIUMKERNEL_H
