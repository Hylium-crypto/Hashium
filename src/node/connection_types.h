...
#ifndef HSMIUM_NODE_CONNECTION_TYPES_H
#define HSMIUM_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/hashium-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Hashium’s Peer-to-Peer Network")
...
#endif // HSMIUM_NODE_CONNECTION_TYPES_H
