...
#ifndef HSMIUM_QT_GUIUTIL_H
#define HSMIUM_QT_GUIUTIL_H
...
/** Utility functions used by the Hashium Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "hashium:" URI into recipient object, return true on successful parsing
