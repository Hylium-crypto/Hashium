...
#ifndef HSMIUM_QT_HSMIUMGUI_H
#define HSMIUM_QT_HSMIUMGUI_H
...
/**
  Hashium GUI main class. This class represents the main window of the Hashium UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class HashiumGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit HashiumGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~HashiumGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a hashium wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, HashiumUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Hashium Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(HashiumUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // HSMIUM_QT_HSMIUMGUI_H
