      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->hashiumAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->hashiumAtStartup);
    ...
    ui->hashiumAtStartup->setToolTip(ui->hashiumAtStartup->toolTip().arg(CLIENT_NAME));
    ui->hashiumAtStartup->setText(ui->hashiumAtStartup->text().arg(CLIENT_NAME));

    ui->openHashiumConfButton->setToolTip(ui->openHashiumConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new HashiumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->hashiumAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSHSMontrols);
...
void OptionsDialog::on_openHashiumConfButton_clicked()
{
