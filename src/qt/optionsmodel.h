...
#ifndef HSMIUM_QT_OPTIONSMODEL_H
#define HSMIUM_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Hashium client.
...
public:
    ...
    HashiumUnit getDisplayUnit() const { return m_display_hashium_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSHSMontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    HashiumUnit m_display_hashium_unit;
...
Q_SIGNALS:
    void displayUnitChanged(HashiumUnit unit);
...
#endif // HSMIUM_QT_OPTIONSMODEL_H
