...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = HashiumUnits::formatWithUnit(unit, amount, true, HashiumUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    HashiumUnit unit{HashiumUnit::HSM};
...
{
    HashiumUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(HashiumUnits::formatWithPrivacy(unit, balances.balance, HashiumUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(HashiumUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, HashiumUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(HashiumUnits::formatWithPrivacy(unit, balances.immature_balance, HashiumUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(HashiumUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, HashiumUnits::SeparatorStyle::ALWAYS, m_privacy));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("HSM")
    updateDisplayUnit();
}
