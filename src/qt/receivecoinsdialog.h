...
#ifndef HSMIUM_QT_RECEIVECOINSDIALOG_H
#define HSMIUM_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of hashiums */
...
#endif // HSMIUM_QT_RECEIVECOINSDIALOG_H
