...
//! Entry point for HashiumApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &HashiumApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for HashiumGUI tests.
void AppTests::guiTests(HashiumGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &HashiumGUI::consoleShown, this, &AppTests::consoleTests);
