...
{
    // Test regression https://github.com/hashium/hashium/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/hashium-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/hashium-core/gui/pull/568.
    // With fListen=false in ~/.config/Hashium/Hashium-Qt.conf and all else left as default,
    // hashium-qt should set both -listen and -listenonion to false and start successfully.
