...
#ifndef HSMIUM_QT_WALLETVIEW_H
#define HSMIUM_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a hashium wallet, and offers access to
