...
#ifndef HSMIUM_RPC_PROTOCOL_H
#define HSMIUM_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in hashiumd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Hashium is not connected
