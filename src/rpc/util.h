...
#ifndef HSMIUM_RPC_UTIL_H
#define HSMIUM_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting HSM/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1HSM/kvB.
 */
