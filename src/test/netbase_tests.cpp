// Copyright (c) 2012-present The Hashium Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.hashiumcore.org", "www.hashiumcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.hashiumcore.org]", "www.hashiumcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.hashiumcore.org:80", "www.hashiumcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.hashiumcore.org]:80", "www.hashiumcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.hashiumcore.org:65536", "www.hashiumcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.hashiumcore.org:0", "www.hashiumcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.hashiumcore.org:", "www.hashiumcore.org:", 0, false));
}
