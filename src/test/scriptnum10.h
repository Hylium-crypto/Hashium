...
#ifndef HSMIUM_TEST_SCRIPTNUM10_H
#define HSMIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Hashium Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // HSMIUM_TEST_SCRIPTNUM10_H
