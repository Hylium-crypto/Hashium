// Copyright (c) 2019-2020 The Hashium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HSMIUM_TEST_UTIL_TRANSACTION_UTILS_H
#define HSMIUM_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // HSMIUM_TEST_UTIL_TRANSACTION_UTILS_H
