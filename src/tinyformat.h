...
#include <algorithm>
#include <attributes.h> // Added for Hashium Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Hashium Core
#include <util/string.h> // Added for Hashium Core
...
// Added for Hashium Core. Similar to std::runtime_format from C++26.
...
// Added for Hashium Core. Wrapper for checking format strings at compile time.
