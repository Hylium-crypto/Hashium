// Mine Hashium genesis blocks (main/testnet/test4/regtest).
...
//
// Optional env:
//   HSMIUM_GENESIS_THREADS=N
//   HSMIUM_GENESIS_NETS=main,testnet,test4,regtest
//   HSMIUM_GENESIS_START=<nonce_offset>
//   HSMIUM_GENESIS_EXTRANONCE_START=<extra_nonce_offset>
//
...
static void MineGenesis(const NetSpec& spec, unsigned threads)
{
    ...
    const uint32_t extra_start = GetEnvUint("HSMIUM_GENESIS_EXTRANONCE_START", spec.extra_nonce);
