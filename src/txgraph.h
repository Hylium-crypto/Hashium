...
#ifndef HSMIUM_TXGRAPH_H
#define HSMIUM_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvinghashium.org/t/introduction-to-cluster-linearization/1032
 *
