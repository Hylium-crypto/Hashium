...
#ifndef HSMIUM_TXMEMPOOL_H
#define HSMIUM_TXMEMPOOL_H
 ...
 * Hashium-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the Hashium-specific parts of mempool
