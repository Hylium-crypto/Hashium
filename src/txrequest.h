...
#ifndef HSMIUM_TXREQUEST_H
#define HSMIUM_TXREQUEST_H
 ...
 *   specific transaction. See https://hashiumcore.org/en/2024/07/03/disclose_already_asked_for.
 */
