...
// Copyright 2015 Hashium Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef HSMIUM_UNIVALUE_INCLUDE_UNIVALUE_H
#define HSMIUM_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // HSMIUM_UNIVALUE_INCLUDE_UNIVALUE_H
