...
#ifndef HSMIUM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define HSMIUM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // HSMIUM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
