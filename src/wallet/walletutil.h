// Copyright (c) 2017-2021 The Hashium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HSMIUM_WALLET_WALLETUTIL_H
#define HSMIUM_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! hashium from opening the wallet, thinking it was newly created, and
...
#endif // HSMIUM_WALLET_WALLETUTIL_H
