...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HashiumTestFramework
    pass


class ExampleTest(HashiumTestFramework):
    # Each functional test is a subclass of the HashiumTestFramework class.
    ...
    def custom_method(self):
        ...
        HashiumTestFramework class so other tests can use it."""
