...
class FullBlockTest(HashiumTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure hashiumd isn't accepting b26
        ...
        # Extend the b28 chain to make sure hashiumd isn't accepting b28
        ...
        # hashiumd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the hashium code has custom code which does so);
