...
class HashiumReorgBasicTest(HashiumTestFramework):
    ...
    def run_test(self):
        ...
        # Το sync_all κάνει και sync_mempools, και ο Hashium δεν κάνει πάντα relay resurrected txs μετά από reorg.
        self.sync_blocks()
...
if __name__ == "__main__":
    HashiumReorgBasicTest(__file__).main()
