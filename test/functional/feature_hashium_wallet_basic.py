...
"""Test wallet functionality on Hashium network.
...
class HashiumWalletTest(HashiumTestFramework):
    ...
    def run_test(self):
        self.log.info("Testing Hashium wallet functionality...")
    ...
    def test_address_generation(self):
        ...
        # Verify Hashium prefixes (regtest uses 'rhyl')
    ...
    def test_send_receive(self):
        ...
        self.log.info(f"Sent {amount} HSM, txid: {txid}")
...
if __name__ == "__main__":
    HashiumWalletTest(__file__).main()
