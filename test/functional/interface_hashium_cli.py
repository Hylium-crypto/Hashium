...
# The block reward of coinbaseoutput.nValue (50) HSM/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 HSM/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"hashium-cli -h\" for help or \"hashium-cli listwallets\" to see "
...
class TestHashiumCli(HashiumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `hashium-cli getblockchaininfo`")
        ...
        # Prevent hashium-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and hashium-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and hashium-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (HSM/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (HSM/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 HSM) to the default wallet.
            ...
            # Test hashium-cli -generate with -rpcwallet in multiwallet mode.
