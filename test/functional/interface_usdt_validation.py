...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/hashium/hashium/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(HashiumTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/hashium/hashium/blob/master/doc/tracing.md#tracepoint-validationblock_connected
