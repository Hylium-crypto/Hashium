...
By default, hashiumd will dump mempool on shutdown and
...
class MempoolPersistTest(HashiumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent hashiumd from writing mempool.dat to disk. Verify that `savemempool` fails")
