...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The hashiumd node closes feeler connections as soon as a version
...
class P2PAddConnections(HashiumTestFramework):
    ...
    def run_test(self):
        ...
        # hashiumd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that hashiumd sends its own version prior to processing
