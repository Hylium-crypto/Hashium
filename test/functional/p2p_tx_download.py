#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Hashium Core developers
...
class TxDownloadTest(HashiumTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new hashiumd instances, as setting mocktimes has long-term effects on when
