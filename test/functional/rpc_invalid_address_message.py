...
BECH32_VALID_CAPITALS = 'RHSM1QTMP74AYG7P24USLCTSSVJM06Q5PHZ4YRECPPFX'
...
BECH32_ONE_ERROR_CAPITALS = 'RHSM1QTMP74AYG7P24USLCTSSVJM06Q5PHZ4YRQCPPFX'
...
class InvalidAddressErrorMessageTest(HashiumTestFramework):
    ...
    def test_validateaddress(self):
        ...
        if not self.options.usecli:
            ...
            assert_raises_rpc_error(-1, "Return information about the given hashium address.", node.validateaddress)
