...
Verify that a hashiumd node can use an external signer command.
...
class RPCSignerTest(HashiumTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart hashiumd with -signer=<cmd>',
