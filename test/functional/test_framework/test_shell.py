...
class TestShell:
    """Wrapper Class for HashiumTestFramework.

    The TestShell class extends the HashiumTestFramework
    ...
    class __TestShell(HashiumTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by HashiumTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # HashiumTestFramework instances are supposed to be constructed with the path
