...
class HashiumChainstateTest(HashiumTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_hashium_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing hashium-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    HashiumChainstateTest(__file__).main()
