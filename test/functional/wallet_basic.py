...
class WalletTest(HashiumTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 HSM from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 HSM with subtract fee from amount
        ...
        # Sendmany 10 HSM with subtract fee from amount
        ...
        # Sendmany 5 HSM to two addresses with subtracting fee from both addresses
