#!/usr/bin/env python3
# Copyright (c) 2020-2022 The Hashium Core developers
...
class WalletSendTest(HashiumTestFramework):
    ...
    def run_test(self):
        ...
        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, change_address="not an address",
                       expect_error=(-5, "Change address must be a valid hashium address"))
