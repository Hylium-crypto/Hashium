...
class TxnMallTest(HashiumTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 HSM:
        ...
        # First: use raw transaction API to send 1240 HSM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 HSM coin each
        ...
        # Node0's balance should be starting balance, plus 50HSM for another
        ...
        # Node0's total balance should be starting balance, plus 100HSM for
