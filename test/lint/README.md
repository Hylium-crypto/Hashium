...
```sh
DOCKER_BUILDKIT=1 docker build --platform=linux --tag=hashium-linter --file="./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/hashium -it hashium-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/hashium-core/crc32c-subtree.git (branch hashium-fork)
* for `src/crypto/ctaes`: https://github.com/hashium-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/hashium-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/hashium-core/leveldb-subtree.git (branch hashium-fork)
* for `src/minisketch`: https://github.com/hashium-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/hashium-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/hashium-core/secp256k1.git
```
