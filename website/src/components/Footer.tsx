        ...
        <footer style={{
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '32px', marginBottom: '32px' }}>
                    ...
                    <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                            <img src="/logo.png" alt="Hashium" style={{ width: '32px', height: '32px' }} />
                            <span style={{ fontWeight: 700, fontSize: '18px', color: '#0f172a' }}>Hashium</span>
                        </div>
                ...
                <div style={{
                    ...
                    <p style={{ color: '#94a3b8', fontSize: '14px' }}>© 2024 Hashium. All rights reserved.</p>
